% Resolución de Ecuaciones Diferenciales (ED) por medio de Runge-Kutta Fehlberg Orden 5
...
disp('Resolucion de ED por medio de Runge-Kutta-Fehlberg Orden 5')
...
for i=2:N
    ...
    K6 = h*subs(F1,[t,y],[mED(i-1,1) + (h/2),mED(i-1,2) - (8/27)*K1 + 2*K2 - (3544/2565)*K3 + (1859/4104)*K4 - (11/40)*K5]);
    ...
    mED(i,1) = mED(i-1,1) + h;
    mED(i,2) = mED(i-1,2) + (16/135)*(K1) + (6656/12825)*K3 + (28561/56430)*K4 - (9/50)*K5 + (2/55)*K6;
